...
def shape(input):
    ...
    output = re.sub(u'\u101B([\u006B\u006C])', u'\u00BD\\1', output) # YaTo.TCN/NaCN...
...
def visual2logical(input):
    output = input
    output = re.sub(u'\u102D([\u102F\u1030])', u'\\1\u102D', output) # LoneGyi.TCN/NaCN...
    output = re.sub(u'\u102E([\u102F\u1030])', u'\\1\u102E', output) # LoneGyiSan.TCN/NaCN...
    ...
    output = re.sub(u'\u100A([\u0054])', u'\u00F1\\1', output)  # Nya.Htoe...
