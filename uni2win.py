...
def shape(input):
    ...
    # output = re.sub(u'\u1014([\u103B\u103D\u103E\u103F])', u'\u0045\\1', output) # NaPyat...Pint/Swe/Htoe...
    # output = re.sub(u'(\u103C)\u1014((?:[\u103B\u103D\u103E\u103F])?)', u'\\1\u0045\\2', output) # NaPyat...Yit/Pint/Swe/Htoe...
...
def visual2logical(input):
    output = input
    output = re.sub(u'\u102D([\u102F\u1030])', u'\\1\u102D', output) # LoneGyi.TCN...
    output = re.sub(u'\u102E([\u102F\u1030])', u'\\1\u102E', output) # LoneGyi.TCN...
    ...
    output = re.sub(u'([\u1000-\u1021])\u103C\u0054', u'\u103C\\1\u0054', output) # Yit...Byee...
    output = re.sub(u'([])', u'\\1\u0059', output) # OutMyint...
