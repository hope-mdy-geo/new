...
def replace(input):
    ...
    #output = re.sub(u'\u104F', u'\u005C', output) # Ei...
    return output

def decompose(input):
    output = input
    output = re.sub(u'\u103A\u1003', u'\u00A2', output) # GaGyi...
    #output = re.sub(u'\u103A\u1011', u'\u00A6', output) # ...Hta...
    output = re.sub(u'\u103A\u1013', u'\u00A8', output) # DaOut...
    output = re.sub(u'\u103A\u1001', u'\u00A9', output) # Kha...
    output = re.sub(u'\u103A\u1011', u'\u00AC', output) # Hta...
    output = re.sub(u'\u103A\u1019', u'\u00AE', output) # Ma...
    output = re.sub(u'\u103A\u100B', u'\u00B3', output) # TaTaLin...
    output = re.sub(u'\u103A\u1012', u'\u00B4', output) # DaDway...
    output = re.sub(u'\u103A\u1002', u'\u00BE', output) # Ga...
    output = re.sub(u'\u103A\u1017', u'\u00C1', output) # BaHtaChite...
    #output = re.sub(u'\u103A\u1010', u'\u00C5', output) # ...TaWan...
    output = re.sub(u'\u103A\u1007', u'\u00C6', output) # Za...
    output = re.sub(u'\u103A\u1018', u'\u00C7', output) # Ba...
    output = re.sub(u'\u103A\u1010\u103D', u'\u00C9', output) # Twa...
    output = re.sub(u'\u103A\u1009', u'\u00D1', output) # ZaMyinZwe...
    output = re.sub(u'\u103A\u100F', u'\u00D6', output) # NaGyi...
    output = re.sub(u'\u103A\u1015', u'\u00DC', output) # Pa...
    output = re.sub(u'\u103A\u1006', u'\u00E4', output) # SaLai...
    output = re.sub(u'\u103A\u1010', u'\u00E5', output) # TaWan...
    output = re.sub(u'\u103A\u1016', u'\u00E6', output) # Pha...
    output = re.sub(u'\u103A\u1014', u'\u00E9', output) # Na...
    output = re.sub(u'\u103A\u1005', u'\u00F6', output) # SaLone...
    output = re.sub(u'\u103A\u1000', u'\u00FA', output) # Ka...
    #output = re.sub(u'\u103A\u1006', u'\u00E4', output) # SaLai...
    return output
...
def visual2logical(input):
    output = input
    output = re.sub(u'([\u1000-\u1021])((?:\u103B)?)((?:\u103C)?)((?:\u103D)?)((?:\u103E)?)((?:\u1031)?)', '\\6\\3\\1\\2\\4\\5', output) # ThaWayHtoe...Pint/Yit/Swe/Htoe...
